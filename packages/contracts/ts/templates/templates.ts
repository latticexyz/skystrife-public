...
const settlementTemplate = {
  ...
  Factory: {
    ...
    staminaCosts: [400, 700, 900, 1100, 1800],
  },
...
export const templates: TemplatesConfig<typeof config> = {
  ...
  SpawnSettlement: {
    ...settlementTemplate,
    Charger: { value: 200 },
    ChargeCap: { cap: 6400, totalCharged: 0 },
