...
library SeasonPassPrivateMatchLimit {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SeasonPassPrivat", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536561736f6e50617373507269766174);
