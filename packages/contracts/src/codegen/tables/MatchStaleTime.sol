...
library MatchStaleTime {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchStaleTime", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d617463685374616c6554696d650000);
