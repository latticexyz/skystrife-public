...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("MatchAccessContr")))
);
ResourceId constant MatchAccessControlTableId = _tableId;
...
library MatchAccessControl {
   ...
   * @notice Get systemId.
   */
  function getSystemId(bytes32 key) internal view returns (ResourceId systemId) {
   ...
   * @notice Get systemId.
   */
  function _getSystemId(bytes32 key) internal view returns (ResourceId systemId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get systemId.
   */
  function get(bytes32 key) internal view returns (ResourceId systemId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get systemId.
   */
  function _get(bytes32 key) internal view returns (ResourceId systemId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set systemId.
   */
  function setSystemId(bytes32 key, ResourceId systemId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set systemId.
   */
  function _setSystemId(bytes32 key, ResourceId systemId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set systemId.
   */
  function set(bytes32 key, ResourceId systemId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set systemId.
   */
  function _set(bytes32 key, ResourceId systemId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
