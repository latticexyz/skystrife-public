...
bytes32 constant templateId = "RockWall";
bytes32 constant RockWallTemplateId = templateId;
uint256 constant LENGTH = 2;

function RockWallTemplate() {
  ...
  (staticData, encodedLengths, dynamicData) = TerrainType.encode(TerrainTypes(uint8(11)));
