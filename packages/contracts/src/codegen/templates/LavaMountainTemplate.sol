...
bytes32 constant templateId = "LavaMountain";
bytes32 constant LavaMountainTemplateId = templateId;
uint256 constant LENGTH = 2;

function LavaMountainTemplate() {
  ...
  (staticData, encodedLengths, dynamicData) = TerrainType.encode(TerrainTypes(uint8(9)));
