...
bytes32 constant templateId = "Lava";
bytes32 constant LavaTemplateId = templateId;
uint256 constant LENGTH = 2;

function LavaTemplate() {
  ...
  (staticData, encodedLengths, dynamicData) = TerrainType.encode(TerrainTypes(uint8(8)));
