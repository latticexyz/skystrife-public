...
function HalberdierTemplate() {
  ...
  (staticData, encodedLengths, dynamicData) = Combat.encode(400000, 400000, 0, 70000, 0, -30);
  ...
  (staticData, encodedLengths, dynamicData) = CombatArchetype.encode(CombatArchetypes(uint8(3)));
