...
bytes32 constant templateId = "Dragon";
bytes32 constant DragonTemplateId = templateId;
uint256 constant LENGTH = 7;

function DragonTemplate() {
  ...
  (staticData, encodedLengths, dynamicData) = Combat.encode(350000, 350000, 10000, 110000, 40000, 70);
