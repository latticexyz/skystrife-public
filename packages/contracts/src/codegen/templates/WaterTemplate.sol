...
bytes32 constant templateId = "Water";
bytes32 constant WaterTemplateId = templateId;
...
function WaterTemplate() {
  ...
  (staticData, encodedLengths, dynamicData) = TerrainType.encode(TerrainTypes(uint8(4)));
