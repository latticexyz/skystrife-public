...
export const PLAYER_DEREGISTER_SYSTEM_ID = resourceToHex({ type: "system", namespace: "", name: "PlayerDeregister" });
export const MATCH_SYSTEM_ID = resourceToHex({ type: "system", namespace: "", name: "MatchSystem" });
export const CANCEL_MATCH_SYSTEM_ID = resourceToHex({ type: "system", namespace: "", name: "CancelMatchSyste" });
